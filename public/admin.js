...
if (posterPrintBtn && posterEl) {
  posterPrintBtn.addEventListener('click', () => {
    ...
    if (!win) return;
    const html = `<!doctype html><html><head><meta charset="utf-8"/><title>Decor QR</title><style>body{font-family:Sora,Arial,sans-serif;margin:24px;background:#f5f7fb;} .poster-wrap{border-radius:24px;padding:28px;border:2px solid rgba(0,224,255,.3);background:#fff;box-shadow:0 20px 48px rgba(11,15,25,.18);max-width:520px;margin:0 auto;text-align:center;position:relative;overflow:hidden;} .poster-header{display:flex;flex-direction:column;align-items:center;gap:10px;margin-bottom:12px;} .poster-header h3{font-size:1.15rem;letter-spacing:.02em} .poster-logo{width:72px;height:72px;border-radius:16px;object-fit:cover;border:1px solid rgba(0,224,255,.35);box-shadow:0 10px 24px rgba(0,224,255,.25);} .poster-badge{display:inline-flex;align-items:center;justify-content:center;padding:6px 14px;border-radius:999px;font-size:.85rem;font-weight:700;letter-spacing:.04em;text-transform:uppercase;margin:4px auto 10px;background:rgba(255,255,255,.8);border:1px solid rgba(0,224,255,.4);} .poster-title{font-size:1.35rem;font-weight:700;margin:6px 0 18px;color:#0b0f19;} .poster-qr{width:240px;height:240px;margin:0 auto 16px;padding:10px;border-radius:16px;border:2px solid #0b0f19;display:flex;align-items:center;justify-content:center;box-sizing:border-box;background:#fff;box-shadow:0 14px 28px rgba(11,15,25,.18);} .poster-qr canvas,.poster-qr img{width:100%;height:100%;display:block;} .poster-footer{color:#4a5468;font-size:.9rem} .poster-wrap.theme-neon{background:radial-gradient(circle at top,rgba(255,255,255,.95),rgba(231,240,255,.9) 45%,rgba(210,229,255,.85) 100%),repeating-linear-gradient(135deg,rgba(0,224,255,.12),rgba(0,224,255,.12) 12px,rgba(255,59,255,.08) 12px,rgba(255,59,255,.08) 24px);border-color:rgba(0,224,255,.4);box-shadow:0 20px 48px rgba(11,15,25,.25),0 0 32px rgba(0,224,255,.2);} .poster-wrap.theme-dark{background:radial-gradient(circle at top,#1d2230,#0f1320 55%,#0b0f19 100%),repeating-linear-gradient(135deg,rgba(255,196,0,.18),rgba(255,196,0,.18) 14px,rgba(0,224,255,.12) 14px,rgba(0,224,255,.12) 28px);border-color:rgba(255,196,0,.35);box-shadow:0 20px 48px rgba(0,0,0,.45),0 0 28px rgba(255,196,0,.2);color:#f5f7fb;} .poster-wrap.theme-sunset{background:radial-gradient(circle at top,rgba(255,245,229,.98),rgba(255,210,170,.9) 45%,rgba(255,168,119,.85) 100%),repeating-linear-gradient(135deg,rgba(255,92,0,.18),rgba(255,92,0,.18) 14px,rgba(255,214,142,.18) 14px,rgba(255,214,142,.18) 28px);border-color:rgba(255,153,51,.45);box-shadow:0 20px 48px rgba(255,153,51,.25),0 0 30px rgba(255,92,0,.2);} .poster-wrap.theme-dark .poster-title{color:#f5f7fb;} .poster-wrap.theme-dark .poster-footer{color:rgba(245,247,251,.7);} .poster-wrap.theme-dark .poster-badge{background:rgba(15,19,32,.85);border-color:rgba(255,196,0,.5);color:#ffd06a;} .poster-wrap.theme-neon::before{content:'';position:absolute;top:-120px;right:-120px;width:260px;height:260px;background:radial-gradient(circle,rgba(255,59,255,.35),rgba(255,59,255,0));opacity:.6;} .poster-wrap.theme-neon::after{content:'';position:absolute;bottom:-140px;left:-120px;width:300px;height:300px;background:radial-gradient(circle,rgba(0,224,255,.35),rgba(0,224,255,0));opacity:.6;} .poster-wrap.theme-dark::before{content:'';position:absolute;top:-120px;right:-120px;width:260px;height:260px;background:radial-gradient(circle,rgba(255,196,0,.4),rgba(255,196,0,0));opacity:.55;} .poster-wrap.theme-dark::after{content:'';position:absolute;bottom:-140px;left:-120px;width:300px;height:300px;background:radial-gradient(circle,rgba(0,224,255,.2),rgba(0,224,255,0));opacity:.4;} .poster-wrap.theme-sunset::before{content:'';position:absolute;top:-120px;right:-120px;width:260px;height:260px;background:radial-gradient(circle,rgba(255,92,0,.4),rgba(255,92,0,0));opacity:.6;} .poster-wrap.theme-sunset::after{content:'';position:absolute;bottom:-140px;left:-120px;width:300px;height:300px;background:radial-gradient(circle,rgba(255,214,142,.5),rgba(255,214,142,0));opacity:.6;}</style></head><body>${posterEl.outerHTML}<script>window.onload=()=>window.print();</script></body></html>`;
